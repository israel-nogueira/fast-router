...
use IsraelNogueira\fastRouter\Test\Controllers\MiddlewareProvidingController;
...
class ControllerTest extends TestCase
{
    ...
    public function can_add_single_middleware_via_controller()
    {
        ...
        $router->get(
            '/test/123',
            'IsraelNogueira\fastRouter\Test\Controllers\MiddlewareProvidingController@returnOne'
        );
    ...
    protected function assertMiddlewareIsAppliedToMethods($router, $middlewareAppliedToMethods)
    {
        ...
        foreach ($middlewareAppliedToMethods as $method => $applied) {
            $router->get(
                '/test/' . $method,
                'IsraelNogueira\fastRouter\Test\Controllers\MiddlewareProvidingController@' . $method
            );
        }
