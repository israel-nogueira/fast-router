...
use IsraelNogueira\fastRouter\Test\Controllers\TestController;
use IsraelNogueira\fastRouter\Test\Requests\TestRequest;
...
class RouterDITest extends TestCase
{
    ...
    public function route_params_are_injected_into_controller_class()
    {
        ...
        $router->get('/posts/{postId}/comments/{commentId}', 'IsraelNogueira\fastRouter\Test\Controllers\TestController@expectsInjectedParams');
    ...
    public function typehints_are_injected_into_controller_class()
    {
        ...
        $router->get('/test/route', 'IsraelNogueira\fastRouter\Test\Controllers\TestController@typeHintTestService');
    ...
    public function typehints_are_injected_into_controller_class_with_params()
    {
        ...
        $router->get('/posts/{postId}/comments/{commentId}', 'IsraelNogueira\fastRouter\Test\Controllers\TestController@typeHintTestServiceWithParams');
    ...
    public function constructor_params_are_injected_into_controller_class()
    {
        ...
        $router->get('/test/url', 'IsraelNogueira\fastRouter\Test\Controllers\TestConstructorParamController@returnTestServiceValue');
