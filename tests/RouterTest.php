...
use IsraelNogueira\fastRouter\Exceptions\NamedRouteNotFoundException;
use IsraelNogueira\fastRouter\Exceptions\RouteClassStringControllerNotFoundException;
use IsraelNogueira\fastRouter\Exceptions\RouteClassStringMethodNotFoundException;
use IsraelNogueira\fastRouter\Exceptions\RouteClassStringParseException;
use IsraelNogueira\fastRouter\Exceptions\RouteParamFailedConstraintException;
use IsraelNogueira\fastRouter\Exceptions\TooLateToAddNewRouteException;
use IsraelNogueira\fastRouter\Route;
use IsraelNogueira\fastRouter\RouteGroup;
...
class RouterTest extends TestCase
{
    ...
    public function match_works_with_a_class_and_method_string()
    {
        ...
        $route = $router->get('/test/123', 'IsraelNogueira\fastRouter\Test\Controllers\TestController@returnHelloWorld');
        $response = $router->match($request);
    ...
    public function match_throws_exception_when_class_and_string_method_contains_an_unfound_class()
    {
        ...
        $route = $router->get('/test/123', 'IsraelNogueira\fastRouter\Test\Controllers\UndefinedController@returnHelloWorld');
    }
    ...
    public function match_throws_exception_when_class_and_string_method_contains_an_unfound_method()
    {
        ...
        $route = $router->get('/test/123', 'IsraelNogueira\fastRouter\Test\Controllers\TestController@undefinedMethod');
    }
