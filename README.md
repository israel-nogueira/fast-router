...
You can also apply Middleware on a Controller class too. In order to do this your Controller must extend the `IsraelNogueira\fastRouter\Controller` base class.
